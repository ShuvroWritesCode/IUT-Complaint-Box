...
const ComplaintForm = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="w-full my-auto mx-auto rounded-xl border-2 border-red-pastel p-5 m-5">
        <div className="mb-4">
          ...
          <textarea
            ...
            rows="4"
            className="font-serif text-sm mt-4 block w-full border-2 border-gray-300 rounded-md focus:ring-0"
          />
        </div>
        <div className="mb-4">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3">
              {tags.map((tag, index) => (
                <span key={index} className="flex items-center mt-4 px-3 py-1 text-sm font-semibold text-red-pastel rounded-2xl border-2 border-red-pastel hover:text-red-pastel">
                  {tag}
                  <button
                    type="button"
